...
public class ExoticaForestLeaveDecorator extends LeaveVineDecorator {
	public static final ExoticaForestLeaveDecorator INSTANCE = new ExoticaForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("exotica_forest_tree_leave_decorator");
